...
class PrintRequestMapperTest {
    ...
    fun `should map send application to print message to print request given existing Welsh address details`(
        ...
        given(deliveryAddressTypeMapper.mapSqsToEntity(any())).willReturn(DeliveryAddressType.REGISTERED)
        ...
        verify(deliveryAddressTypeMapper).mapSqsToEntity(deliveryAddressTypeModelEnum)
