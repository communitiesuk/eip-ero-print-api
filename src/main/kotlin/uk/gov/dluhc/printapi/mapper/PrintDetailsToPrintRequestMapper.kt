...
abstract class PrintDetailsToPrintRequestMapper {
    ...
    @Mapping(source = "details.delivery.address.property", target = "deliverypProperty")
    ...
    @Mapping(source = "details.eroWelsh.address.property", target = "eroDeliverypPropertyCy")
    ...
    @Mapping(source = "details.eroWelsh.address.area", target = "erodDeliveryAreaCy")
