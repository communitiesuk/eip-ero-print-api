...
abstract class AnonymousElectorDocumentMapper {
    ...
    @Mapping(target = "contactDetails", expression = "java( toContactDetails( aedRequest ) )")
    ...
    abstract fun toContactDetails(aedRequest: GenerateAnonymousElectorDocumentDto): AedContactDetails
